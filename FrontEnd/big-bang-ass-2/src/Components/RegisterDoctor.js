...
function RegisterDoctor() {
    ...
    var register = ()=>{
      console.log("**************");
      console.log(doctor);
        fetch("http://localhost:5182/api/User/action/Doctor Register",{
          "method":"POST",
          headers:{
              "accept": "text/plain",
          ...
          <div className="col-md-6 leftDiv">
            <div className="myLeftCtn">
              <div className="myForm text-center">
                <header>Create Doctor Account</header>
                <div className="form-group">
                  ...
                  />
                  {
                      !doctor.users.email.includes('@gmail.com')?(<p className="passwords">*Email should be in the format of *****@gmail.com</p>):(<div></div>)
                  }
                </div>
                &nbsp;
                <div className="form-group">
                  ...
                  />
                  {
                     doctor.password===''|| doctor.password.length<4?(<p className="passwords">*password should be minimum of 4 characters</p>):(<div></div>)
                  }
                </div>
                &nbsp;
                <div className="form-group">
                  ...
                  />
                  {
                     doctor.name===''|| doctor.name.length<4?(<p className="passwords">*Name should be minimum of 4 characters</p>):(<div></div>)
                  }
                </div>
                &nbsp;
                <div className="form-group">
                  ...
                  <input
                    ...
                    required
                    onChange={(event)=>{
                      setDoctor({...doctor, "dob":Date(event.target.value)})
                    }}
                  />
                </div>
                &nbsp;
                <div className="form-group">
                  ...
                  <input
                    ...
                    required
                    onBlur={(event)=>{
                      setDoctor({...doctor, "phoneNo":event.target.value})
                    }}
                  />
                  {
                     doctor.phoneNo.length<10|| doctor.phoneNo.length>10?(<p className="passwords">*Phone No should be 10 characters</p>):(<div></div>)
                  }
                </div>
                &nbsp;
                <div className="form-group">
                ...
                <div className="form-group">
                  ...
                  />
                  {
                     doctor.experience<0?(<p className="passwords">*Experience should be positive number</p>):(<div></div>)
                  }
                </div>
                &nbsp;
                <div className="form-group">
                ...
                <option value="female">Female</option>             
                  ...
                  {
                     doctor.gender!="male"&&doctor.gender!="female"?(<p className="passwords">*Gender Should not be empty</p>):(<div></div>)
                  }
                </div>
